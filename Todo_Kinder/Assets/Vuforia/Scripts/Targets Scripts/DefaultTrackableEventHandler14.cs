...
namespace Vuforia
{
    ...
    /// </summary>
    public class DefaultTrackableEventHandler14 : MonoBehaviour,
                                                ITrackableEventHandler
    {
                                        ...
                                        TrackableBehaviour.Status newStatus)
        {
            ...
            {
                OnTrackingFound();
				control.Encontro_Target14 ();
				//StartCoroutine (Play_Audio());
				control.DesaparecerTrack ();
				Handheld.PlayFullScreenMovie ("K2_ES_R1_2.mp4", Color.black, FullScreenMovieControlMode.CancelOnInput);
            }
            else
            {
                OnTrackingLost();
