...
namespace Vuforia
{
    ...
    /// </summary>
    public class DefaultTrackableEventHandler17 : MonoBehaviour,
                                                ITrackableEventHandler
    {
                                        ...
                                        TrackableBehaviour.Status newStatus)
        {
            ...
            {
                OnTrackingFound();
				control.Encontro_Target17 ();
				//StartCoroutine (Play_Audio());
				control.DesaparecerTrack ();
				Handheld.PlayFullScreenMovie ("K2_ES_R1_10.mp4", Color.black, FullScreenMovieControlMode.CancelOnInput);
            }
            else
            {
                OnTrackingLost();
