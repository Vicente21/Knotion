...
namespace Vuforia
{
    ...
    /// </summary>
    public class DefaultTrackableEventHandler27 : MonoBehaviour,
                                                ITrackableEventHandler
    {
                                        ...
                                        TrackableBehaviour.Status newStatus)
        {
            ...
            {
                OnTrackingFound();
				control.Encontro_Target27 ();
				//StartCoroutine (Play_Audio());
				control.DesaparecerTrack ();
				Handheld.PlayFullScreenMovie ("K3_ES_R1_15.mp4", Color.black, FullScreenMovieControlMode.CancelOnInput);
