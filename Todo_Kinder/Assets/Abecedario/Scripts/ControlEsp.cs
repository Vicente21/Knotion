...
public class ControlEsp : MonoBehaviour {
	...
	{ 
        ...
        animÑ = Letras [14].GetComponent<Animator>();
        animO = Letras [15].GetComponent<Animator> ();
		animP = Letras [16].GetComponent<Animator> ();
		animQ = Letras [17].GetComponent<Animator> ();
		animR = Letras [18].GetComponent<Animator> ();
		animS = Letras [19].GetComponent<Animator> ();
		animT = Letras [20].GetComponent<Animator> ();
		animU = Letras [21].GetComponent<Animator> ();
		animV = Letras [22].GetComponent<Animator> ();
		animW = Letras [23].GetComponent<Animator> ();
		animX = Letras [24].GetComponent<Animator> ();
		animY = Letras [25].GetComponent<Animator> ();
		animZ = Letras [26].GetComponent<Animator> ();
